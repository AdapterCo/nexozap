  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-8">
      ...
      <div className="mt-6">
        ...
        <button
          type="button"
          className="mt-4 w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700"
        >
