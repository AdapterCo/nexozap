...
const DashboardCharts = dynamic(() => import('@/components/dashboard-charts'), {
  ...
  loading: () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2 card p-5 h-[380px] flex items-center justify-center text-gray-400 text-sm animate-pulse bg-gray-50">
        Carregando gráficos...
      </div>
      <div className="card p-5 h-[380px] flex items-center justify-center text-gray-400 text-sm animate-pulse bg-gray-50">
        Carregando gráficos...
      </div>
    </div>
  ),
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <DashboardCharts weeklyData={weeklyData} popularServices={popularServices} />
